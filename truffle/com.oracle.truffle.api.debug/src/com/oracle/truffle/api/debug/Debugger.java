...
import com.oracle.truffle.api.debug.DebuggerInstrument.DebuggerAccess;
...
public final class Debugger {
    ...
    public static Debugger find(PolyglotEngine engine) {
        ...
        return getDebugger(engine, instrument.lookup(DebuggerAccess.class));
    }
    ...
    private static Debugger getDebugger(PolyglotEngine sourceEngine, final DebuggerAccess access) {
        synchronized (access) {
            Debugger debugger = access.getDebugger();
            if (debugger == null) {
                debugger = new Debugger(sourceEngine, access.getEnv());
                access.setDebugger(debugger);
            }
            return debugger;
        }
    }
