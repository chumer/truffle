...
import com.oracle.truffle.api.debug.DebuggerTester;
...
public class SLDebugTest {
    ...
    private SuspendedEvent expectSuspended() {
        return tester.expectSuspended();
    }
    ...
    public void testStepInOver() throws Throwable {
        ...
        try (DebuggerSession session = startSession()) {
            ...
            event = checkState(expectSuspended(), "main", 2, true, "return fac(5)");
            event.prepareStepInto(1);

            event = checkState(expectSuspended(), "fac", 5, true, "n <= 1", "n", "5");
            event.prepareStepOver(1);

            event = checkState(expectSuspended(), "fac", 8, true, "return n * fac(n - 1)", "n", "5");
            event.prepareStepOver(1);
    ...
    public void testDebugger() throws Throwable {
        ...
        try (DebuggerSession session = startSession()) {
            ...
            event = checkState(expectSuspended(), "fac", 6, true, "debugger", "n", "1");
    ...
    public void testNull() throws Throwable {
        ...
        try (DebuggerSession session = startSession()) {
            ...
            event = checkState(expectSuspended(), "main", 2, true, "res = doNull()");
            event.prepareStepInto(1);

            event = checkState(expectSuspended(), "main", 3, true, "return res", "res", "NULL");
            event.prepareContinue();
